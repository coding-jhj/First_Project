...
| 기능 | 트리거 | 설명 |
|---|---|---|
| 장애물 안내 | 자동 (연속 분석) | 위험도 상위 물체를 방향·거리와 함께 음성 안내 |
| 차량 경고 | 자동 | 차량·버스·트럭 탐지 시 즉각 경보 및 진동 |
...
| 비전 모델 | yolo11n_320.tflite (2.8 MB) | COCO 80클래스, 320×320 입력 |
| NLG | 커스텀 한국어 문장 생성 | 조사 자동화, policy.json SSOT |
| TTS / STT | Android 내장 TTS / SpeechRecognizer | |
| HTTP | OkHttp 4.12.0 | 서버 JSON 전송 |
