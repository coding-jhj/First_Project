...
yolo11m_indoor.pt 또는 yolo11m.pt에서 이어서 학습.
학습률을 낮게 유지해 기존 클래스 성능이 무너지지 않도록 함.
...
완료 후:
    yolo11m_indoor.pt 덮어쓰기 (휴대폰 교정 반영)
...
def main():
    ...
    # cellphone_fix.yaml 은 nc=80 (COCO 순서). yolo11m.pt 에서 시작.
    start = "yolo11m.pt"
    print("=" * 60)
