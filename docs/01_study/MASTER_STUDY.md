...
│   ├── MEETING_0428_RESULT.md  ← 4/28 결과 정리
│   ├── MEETING_0429_INSTRUCTOR_FEEDBACK.md ← 강사 피드백 전체
│   ├── MEETING_0429_PREP.md  ← 4/29 발표 준비
│   └── INTERVIEW_0427_ANALYSIS.md ← 시각장애인 인터뷰 분석
│
├── 03_server/
...
4. MEETING_0429_INSTRUCTOR_FEEDBACK.md → 강사 지적사항 파악
...
| 신유득 | Depth V2 상대깊이, bbox 하위30% 값, 계단 감지 12구역 |
...
Module D: Depth (신유득) + Voice (문수찬) — DepthAnythingV2, gTTS, STT
...
### `MEETING_0429_INSTRUCTOR_FEEDBACK.md` — 강사 피드백
...
2. `MEETING_0429_INSTRUCTOR_FEEDBACK.md` (30분)
